 ...
 *Deploying newrelic-home-take-app on AWS ECS Fargate — environment: devl*

*What & why:* newrelic-home-take-app is a simple Flask-based application that demonstrates a complete container deployment lifecycle on AWS. It is being deployed to validate Terraform infrastructure provisioning, Docker image publishing to ECR, and GitHub-based deployment through an assumed AWS role.

*Key changes / impact:*
• Provisioned ECS Fargate infrastructure using Terraform in the existing VPC and subnets
• Added an ECR repository and container-based deployment path for newrelic-home-take-app
